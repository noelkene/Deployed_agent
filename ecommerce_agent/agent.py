...
TICKET_DB = [
    ...
    },
    {
        ...
        "status": "ESCALATED", # Issue needed more attention
    },
    {
        "ticket_id": "3",
        "user_id": "user_b",
        "issue_type": "PAYMENT_FAILURE",
        "status": "CLOSED",    # Issue was resolved
    },
    {
        "ticket_id": "4",
        "user_id": "user_d",
    ...
    },
    {
        ...
        "status": "CLOSED",    # Return was processed
    },
    {
        "ticket_id": "6",
        "user_id": "user_e",
...
root_agent = Agent(
    name="root_agent",
    description="Answers users questions on their ecommerce orders",
